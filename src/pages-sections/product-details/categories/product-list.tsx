...
import ProductsGridView from "components/products-view2/products-grid-view";
import ProductsListView from "components/products-view2/products-list-view";
...
type Props = { product: PricedProduct[], handle: string };
// ========================================================

const ProductCategoriesPageView: FC<Props>  = ({product, handle}) => {
    ...
    <Container sx={{ mt: 4, mb: 6 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={9} xs={12}>
          {view === "grid" ? (
            <ProductsGridView products={product} />
          ) : (
...
export default ProductCategoriesPageView;
